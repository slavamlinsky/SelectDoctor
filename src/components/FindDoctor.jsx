...
const FindDoctor = () => {
  ...
  const validate = (values) => {
    ...
    if (!values.name) {
      ...
      !/^[A-Za-z]{3,30}$/i.test(values.name) //eslint-disable-line
    ) {
      errors.name = "(length 3 to 30) only english letters & space";
    }
  ...
  function filterSpecialities(sex = "0", birthdayDate = null, specData) {
    setFilteredSpecialities(specData);
  ...
  return (
    ...
    >
      {function ShowForm({
        ...
        useEffect(() => {
          filterSpecialities(values.sex, values.birthdayDate, specialities);
